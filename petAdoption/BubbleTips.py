...
class BubbleLabel(QWidget):
    ...
    def show(self):
        ...
        # 窗口开始位置
        startPos = QPoint(
            self._desktop.screenGeometry().width() - self.width() - 700,
            self._desktop.availableGeometry().height()-200 - self.height())
        endPos = QPoint(
            self._desktop.screenGeometry().width() - self.width() - 700,
            self._desktop.availableGeometry().height()-200 - self.height() * 3 - 5)
